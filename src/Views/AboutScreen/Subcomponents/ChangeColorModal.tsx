  ...
  return (
    ...
    >
      <View style={styles.modalView}>
        ...
        <GenericSlider
          value={parseFloat(state.base.red)}
        ...
        <GenericSlider
          value={parseFloat(state.base.green)}
          onValueChange={(value) =>
            dispatch(changeGreenTone(value[0].toFixed()))
          }
          maximumValue={255}
          minimumValue={0}
          animationType="spring"
        ...
        <GenericSlider
          value={parseFloat(state.base.blue)}
          onValueChange={(value) =>
            dispatch(changeBlueTone(value[0].toFixed()))
          }
          maximumValue={255}
          minimumValue={0}
          animationType="spring"
